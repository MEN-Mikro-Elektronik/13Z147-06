 ...
 *       \author Apatil
 *        $Date: 2016/04/27 13:47:42 $
 *    $Revision: 1.1 $
 *
 *       \brief  Z147 test tool for rate (tx part)
 *
...
/*-------------------------------[ History ]--------------------------------
 *
 * $Log: rate_test_tx_part.c,v $
 * Revision 1.1  2016/04/27 13:47:42  Apatil
 * Initial Revision
 *
 *---------------------------------------------------------------------------
